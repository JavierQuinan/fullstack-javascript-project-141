...
### Development
- **Hot Reload**: Restart server manually or use nodemon
- **Database**: SQLite file stored in `data/app.sqlite3`
- **Logs**: Fastify logger outputs to console
- **Port**: Default 3000, configurable via PORT env var

---
_Version: 1.0.2 | Last updated: 2025-11-23 01:35:00 UTC_